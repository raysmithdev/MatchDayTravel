				  ...
				  <div class="col-2">
						    ...
						    <?php 
                                if(!empty($divisions)){
                                    foreach($divisions as $rows){
							             echo '<li><a href="'.base_url().'index.php/home/viewteams?division='.$rows->division_id.'">'.$rows->division_name.'</a></li>';
                                    } 
                                } 
                            ?>
                                ...
                                <ul class="dropdown-menu">
                                    <?php 
                                        if($this->session->userdata('user_type') == "2"){
                                            echo '<li><a href="'.base_url().'index.php/home/team">Create Team</a></li>';
                                            echo '<li><a href="'.base_url().'index.php/home/fixture">Create Fixtures</a></li>';
                                        } 
                                    ?>
					...
					<div class="login">
                        ...
                        if($this->session->userdata('user_id') == null){
						  echo '<a href="'.base_url().'index.php/home/pg_login">';
                          echo '<span id="icon-user">';
                          echo '<i class="fa fa-user"></i>log in</span>';
                          echo '</a>';

                          echo '<a href="'.base_url().'index.php/home/pg_reg"><span>register</span></a>';
                        }
                        else{
                           echo '<a href="'.base_url().'index.php/home/logout">';
                            echo '<span id="icon-user">';
                               echo '<i class="fa fa-user"></i>logout</span>';
                           echo '</a>';
                        }?>
					</div>
